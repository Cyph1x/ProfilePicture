...
def generate_mice_lines(n: int, n_steps: int, distance: float, rotation: float, reverse: bool) -> Group:
    ...
    for i in range(n_steps):
        ...
        mouse_lines = draw.Lines(*mouse_lines, close=True, fill='none',stroke="black",stroke_width=5)
        target_lines = draw.Lines(*target_lines, close=True, fill='none',stroke="black",stroke_width=5)
